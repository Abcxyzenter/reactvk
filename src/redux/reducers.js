    ...
    switch (action.type) {
        ...
        case SUCCESS:
            ...
            for (let i = 0; i < responsedContent.length; i++) {
                let itemName = responsedContent[i].text.split('http')[0].length > 70 ? responsedContent[i].text.split('http')[0].slice(0, 70)+' [подробнее]' : responsedContent[i].text.split('http')[0];
